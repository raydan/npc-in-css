...
class CGrenadeHomer : public CE_Grenade
{
public:
	CE_DECLARE_CLASS( CGrenadeHomer, CE_Grenade );
	...
	void		Spawn( void );
	void		Launch( CEntity *pOwner, CEntity *pTarget, const Vector &vInitVelocity, float m_flHomingSpeed, float fFallSpeed, int nRocketTrailType);
	...
	CEFakeHandle<CRocketTrail>	m_hRocketTrail[3];
...
private:
	...
	void 		GrenadeHomerTouch( CEntity *pOther );
