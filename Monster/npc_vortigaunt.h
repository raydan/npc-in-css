...
//	>> CNPC_Vortigaunt
//=========================================================
class CNPC_Vortigaunt : public CNPC_PlayerCompanion /*CAI_PlayerAlly*/ /*CAI_BaseHumanoid*/
{
public:
	CE_DECLARE_CLASS( CNPC_Vortigaunt, CNPC_PlayerCompanion );
...
private:
	...
	bool	PlayerBelowHealthPercentage( CPlayer *pPlayer, float flPerc );
	void	StartHealing( void );
	void	StopHealing( bool bInterrupt = false );
	void	MaintainHealSchedule( void );
	bool	ShouldHealTarget( CEntity *pTarget );
...
private:
	...
	CFakeHandle			m_hHealTarget;			// The person that I'm going to heal.
	...
	CEntity			*FindHealTarget( void );
	bool			HealBehaviorAvailable( void );
	void			SetHealTarget( CEntity *pTarget, bool bPlayerRequested );
