...
{
public:
	CE_DECLARE_CLASS( CNPC_PlayerCompanion, CAI_PlayerAlly );
...
public:
	...
	bool 			IsSafeFromFloorTurret( const Vector &vecLocation, CEntity *pTurret );
	...
	static bool		IsMortar( CEntity *pEntity );
	static bool		IsSniper( CEntity *pEntity );
	static bool		IsTurret(  CEntity *pEntity );
	static bool		IsGunship( CEntity *pEntity );
...
private:
	void SetupCoverSearch( CEntity *pEntity );
