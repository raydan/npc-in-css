...
public:
	...
	virtual Class_T				ClassifyPassenger( CBaseEntity *pPassenger, Class_T defaultClassification ) = 0;	/* First param is CBaseCombatCharacter, second param/ret is 'Class_T' enum */
