...
IEntityFactoryDictionary_CE *EntityFactoryDictionary_CE()
{
	return GetEntityManager()->GetEntityFactoryDictionary();
}
...
IEntityFactoryDictionary_CE *CEntityManager::GetEntityFactoryDictionary()
{
	return pDict;
}
...
{
	pDict = (IEntityFactoryDictionary_CE *)servertools->GetEntityFactoryDictionary();
