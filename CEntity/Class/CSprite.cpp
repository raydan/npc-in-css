...
CE_LINK_ENTITY_TO_CLASS( env_sprite, CE_CSprite );
CE_LINK_ENTITY_TO_CLASS( env_sprite_oriented, CE_CSprite );
CE_LINK_ENTITY_TO_CLASS( env_glow, CE_CSprite );
...
DEFINE_PROP(m_bWorldSpaceScale, CE_CSprite);
