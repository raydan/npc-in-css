...
public:
	...
	int TranslatePhysBoneToBone( int physicsBone );
...
public:
	...
	inline int			GetHitboxSet() { return m_nHitboxSet; }
...
protected: //Sendprops
	...
	DECLARE_SENDPROP(float, m_flCycle);
	DECLARE_SENDPROP(int, m_nSequence);
