...
class CCombatCharacter_Patch;

class CAI_NPC : public CCombatCharacter_Patch
{
public:
	CE_DECLARE_CLASS(CAI_NPC, CCombatCharacter_Patch);
	...
	virtual CBaseEntity	*CB_GetEnemy()					{ return GetEnemy_CBase(); }
	virtual CBaseEntity	*CB_GetEnemy_const() const		{ return (const_cast<CAI_NPC *>(this))->GetEnemy_CBase(); }
	...
	CEntity		*PlayerInRange( const Vector &vecLocation, float flDist );
...
public:
	...
	//virtual CAI_Navigator *CreateNavigator() { return NULL; }
	//virtual CAI_Pathfinder *CreatePathfinder() { return NULL; }
	//virtual CAI_Motor *CreateMotor() { return NULL; }
...
public:
	...
	virtual void OnClearGoal( CAI_BehaviorBase *pBehavior, CBaseEntity *pGoal );
	virtual bool ShouldAcceptGoal( CAI_BehaviorBase *pBehavior, CBaseEntity *pGoal );
...
public: // Custom
	...
	virtual	Vector GetAttackSpread( CBaseEntity *pWeapon, CBaseEntity *pTarget = NULL );
...
public:
	...
	DECLARE_DEFAULTHEADER(OnClearGoal, void, ( CAI_BehaviorBase *pBehavior, CBaseEntity *pGoal ));
	DECLARE_DEFAULTHEADER(ShouldAcceptGoal, bool, ( CAI_BehaviorBase *pBehavior, CBaseEntity *pGoal ));
...
protected: //Sendprops
	DECLARE_SENDPROP(bool, m_bPerformAvoidance);
...
public: //Datamaps
	...
	DECLARE_DATAMAP(string_t, m_iszPendingWeapon);
	DECLARE_DATAMAP(bool, m_fNoDamageDecal);
	DECLARE_DATAMAP(float, m_flLastStateChangeTime);
	DECLARE_DATAMAP(float, m_flSoundWaitTime);
...
protected:
	...
	DECLARE_DATAMAP(CEFakeHandle<CE_AI_Hint>, m_pHintNode);
	...
	DECLARE_DATAMAP_OFFSET(bool, m_bInChoreo);
	DECLARE_DATAMAP(CEFakeHandle<CE_CBaseFilter>, m_hEnemyFilter);
	DECLARE_DATAMAP(COutputEHANDLE, m_OnFoundEnemy);
	DECLARE_DATAMAP(COutputEHANDLE, m_OnFoundPlayer);
	DECLARE_DATAMAP(int, m_nIdealSequence);
	DECLARE_DATAMAP(Activity, m_IdealTranslatedActivity);
	DECLARE_DATAMAP(Activity, m_IdealWeaponActivity);
	DECLARE_DATAMAP(Activity, m_translatedActivity);
	DECLARE_DATAMAP(bool, m_bPlayerAvoidState);
	DECLARE_DATAMAP(float, m_flNextWeaponSearchTime);
	DECLARE_DATAMAP(COutputEvent, m_OnDenyCommanderUse);
