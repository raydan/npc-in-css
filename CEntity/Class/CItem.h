...
public:
	...
	virtual CEntity *MyTouch( CPlayer *pPlayer ) { return NULL; };
...
template <class BASE_T>
void CItem<BASE_T>::ActivateWhenAtRest(float flTime)
{
...
{
	if(!g_MonsterConfig.m_bEnable_Item_Weapon_Respawn)
	{
		UTIL_Remove(this);
		return;
	}
